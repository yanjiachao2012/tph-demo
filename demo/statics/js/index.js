$(function() {
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            html += '<div class="item-right"><h4><strong>' + res.enterprise + '</strong><span>家</span></h4><p>合作企业</p></div></li>';
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            for (var i = 0; i < res.length; i++) {
                ...
                var remark15 = strOpearte(value.remark, 20);
                if (i == 0) {
...
$("#selectCity").on("click", function() {
    ...
    if (addressList.css("display") == "none") {
        $(this).parent().addClass("selectStatus");
        addressList.fadeIn();

    } else {
        $(this).parent().removeClass("selectStatus");
        addressList.fadeOut();
    }
