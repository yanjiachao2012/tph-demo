...
(function($, window, document, undefined) {
  ...
  $.fn.selectpick = function(options) {
    ...
    return this.each(function(elem_id) {
      ...
      // 生成的div的样式
      var _selectBody = "<div class='selectpick_div_box' onselectstart='return false;'><div class='selectpick_div selectpick_div_" + elem_id + "'  id='selectpick_" + elem_id + "'><span class='selectpick-content' id='selectpick_span_" + elem_id + "'></span><span class='selectpick_icon' id='selectpick_icon_" + elem_id + "'><span class='tip'></span></span></div><div class='selectpick_options selectpick_options_" + elem_id + "'></div></div>";
        ...
        if ($(".selectpick_ul_" + elem_id + " li").length > 0) {
          ...
          $(obj).children("option").each(function() {
            if ($(this).text() == selected_text) {
              ul += "<li class='selectpick_options_selected' style='height:" + (settings.height) + "px; line-height:" + (settings.height) + "px;'><label style='display:none;'>" + $(this).val() + "</label><label>" + $(this).text() + "</label></li>";
            } else {
              ul += "<li style='height:" + (settings.height) + "px; line-height:" + (settings.height) + "px;'><label style='display:none;'>" + $(this).val() + "</label><label>" + $(this).text() + "</label></li>";
            }
          });
          ul += "</ul>";
          ...
          // 每个li点击事件
          $(".selectpick_ul_" + elem_id + " li").on("click", function() {
